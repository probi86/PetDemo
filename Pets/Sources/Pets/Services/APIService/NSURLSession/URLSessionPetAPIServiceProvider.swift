...
public class URLSessionPetAPIServiceProvider: PetAPIServiceProviding {
    ...
    public func loatPets(latitude: Double = 0, longitude: Double = 0, page: Int? = nil) -> AnyPublisher<PetResponse, Error> {
